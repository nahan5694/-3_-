...
window.initOfficeUI = function() {
  ...
  PlayerData.office[t.id] = {
    active: [],
    rest: [],
    progress: 0,
    craftItem: null,
    craftQueue: 0,
    craftCompleteNotice: false
  };
});
  }
...
window.tickOffice = function(dtSeconds) {
  ...
  s.progress = 0;
  s.craftItem = null;
  s.craftCompleteNotice = true;

  if (typeof window.updateMainMenuNotificationDots === 'function') {
    window.updateMainMenuNotificationDots();
  }
}
      }
    }
